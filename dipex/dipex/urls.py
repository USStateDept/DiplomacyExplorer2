...
urlpatterns = patterns('',
    ...
    (r'^(?i)' + settings.BASE_URL + '/$', RedirectView.as_view(url='/' + settings.BASE_URL + '/')),
    url(r'^(?i)' + settings.BASE_URL + '/geoproxy/$', 'layerinfo.views.proxy', name='proxy'),
    url(r'^(?i)' + settings.BASE_URL + '/searchLayers/', 'layerinfo.views.searchLayers', name='searchLayers'),
    url(r'^(?i)' + settings.BASE_URL + '/geojson/$', 'layerinfo.views.geoJson', name='geoJson'),
    url(r'^(?i)' + settings.BASE_URL + '/externalsources/$', 'layerinfo.views.externalSources', name='externalSources'),
