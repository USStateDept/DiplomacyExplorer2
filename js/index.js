...
function onEachFeaturePts(feature, layer) {
	...
	if (feature.properties.PhotoURL.length > 9 && feature.properties.VideoURL > 9){
		popupContent = "<h4>" + feature.properties.Title + "</h4><h5>" + feature.properties.Country + "<br /><div class='row'></div><div class='row'><div class='span collapse-group'><h6 class='collapse' id='viewdetails' style='padding-left: 20px; padding-right: 10px; color: #999; line-height:1.2; margin-bottom: 0px !important;'>" + feature.properties.Story + "</h6><br><div class='btn-group' style='margin:0px 0px 0px 15px;'><button type='button' class='btn btn-default btn-xs' data-toggle='collapse' data-target='#viewdetails'>View Details </button></div></div></div></h5>";
		layer.bindPopup(popupContent);
	} 
	// popup for photo only
	else if (feature.properties.PhotoURL.length > 9 && feature.properties.VideoURL == null){
		popupContent = "<h4>" + feature.properties.Title + "</h4><h5>" + feature.properties.Country + "<br /><div class='row'></div><div class='row'><div class='span collapse-group'><h6 class='collapse' id='viewdetails' style='padding-left: 20px; padding-right: 10px; color: #999; line-height:1.2; margin-bottom: 0px !important;'>" + feature.properties.Story + "</h6><br><div class='btn-group' style='margin:0px 0px 0px 15px;'><button type='button' class='btn btn-default btn-xs' data-toggle='collapse' data-target='#viewdetails'>View Details </button></div></div></div></h5>";
		layer.bindPopup(popupContent);
	}
	// popup for video only
	else if (feature.properties.PhotoURL.length == null && feature.properties.VideoURL > 9){
		popupContent = "<h4>" + feature.properties.Title + "</h4><h5>" + feature.properties.Country + "<br /><div class='row'></div><div class='row'><div class='span collapse-group'><h6 class='collapse' id='viewdetails' style='padding-left: 20px; padding-right: 10px; color: #999; line-height:1.2; margin-bottom: 0px !important;'>" + feature.properties.Story + "</h6><br><div class='btn-group' style='margin:0px 0px 0px 15px;'><button type='button' class='btn btn-default btn-xs' data-toggle='collapse' data-target='#viewdetails'>View Details </button></div></div></div></h5>";
		layer.bindPopup(popupContent);
	// popup text only
	} else {
		popupContent = "<h4>" + feature.properties.Title + "</h4><h5>" + feature.properties.Country + "<br /><div class='row'><div class='span collapse-group'><h6 class='collapse' id='viewdetails' style='padding-left: 20px; padding-right: 10px; color: #999; line-height:1.2; margin-bottom: 0px !important;'>" + feature.properties.Story + "</h6><br><div class='btn-group' style='margin:0px 0px 0px 15px;'><button type='button' class='btn btn-default btn-xs' data-toggle='collapse' data-target='#viewdetails'>View Details </button></div></div></div></h5>";
		layer.bindPopup(popupContent);
	} 
	*/
	// old code
