...
SELECT 
	"ne_50m_admin_0_countries_usg_dipex"."sovereignt",
	"PA_Data"."Geounit",
	"PA_Data"."Country",
	"PA_Data"."ISO_3166",
	"ne_50m_admin_0_countries_usg_dipex"."bureau" as "Bureau",
	"PA_Data"."PEPFAR_2014",
	...
	"PA_Data"."UNHCRcamps",
	the_geom
FROM opengeo."ne_50m_admin_0_countries_usg_dipex" LEFT OUTER JOIN public."PA_Data" ON ("ne_50m_admin_0_countries_usg_dipex"."geounit" = "PA_Data"."Geounit");

DROP TABLE IF EXISTS public."DiscoverDiplomacy-Data_50m_Lakes";
CREATE TABLE public."DiscoverDiplomacy-Data_50m_Lakes" AS
SELECT 
	"ne_50m_admin_0_countries_lakes_usg_dipex"."sovereignt",
	"PA_Data"."Geounit",
	"PA_Data"."Country",
	"PA_Data"."ISO_3166",
	"ne_50m_admin_0_countries_lakes_usg_dipex"."bureau" as "Bureau",
	"PA_Data"."PEPFAR_2014",
	"PA_Data"."NNPTSignedDeposited_2014",
	"PA_Data"."MaternalHealthAccessToCare_2014",
	"PA_Data"."TIPS_2013",
	...
	"PA_Data"."UNHCRcamps",
	the_geom
FROM opengeo."ne_50m_admin_0_countries_lakes_usg_dipex" LEFT OUTER JOIN public."PA_Data" ON ("ne_50m_admin_0_countries_lakes_usg_dipex"."geounit" = "PA_Data"."Geounit");